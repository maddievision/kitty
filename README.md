...
- Uses built in mixer to mix up to 8 voices in DirectSound
- Soundbank format similar to the one used in Sappy.
...
- Add support for GBC Wave and Noise channels
- GBC in Soundbanks
- GBC ADSR envelopes
- Migrate from BIOS mixer to https://github.com/ipatix/gba-hq-mixer
